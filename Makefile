...
build:  ## Build docker image
	docker build --pull --target common -t python-insecure-app .
...
install_base:  ## Install base requirements and dependencies
	python3 -m pip install --quiet --upgrade pip~=24.2.0 -r requirements/base.txt

.PHONY: install_common
install_common: install_base  ## Install common requirements and dependencies
	python3 -m uv pip sync requirements/common.txt

.PHONY: install_dev
install_dev: install_base  ## Install dev requirements and dependencies
